...
| **Adoção/Usuários** | **Baixa Adoção do Agricultor**: Produtores evitam a plataforma por desconfiança em relação ao digital ou preferência por canais tradicionais. | **Foco na Usabilidade e Educação (Jornada de João):** Interface **simples, guiada** e acessível via smartphone. **Módulo de Suporte (RF-SUP-001):** Chatbot integrado e atendimento escalonado para resolver dúvidas rapidamente e construir confiança. |
